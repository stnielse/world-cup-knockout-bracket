...
Database: I initially wanted to use api-football.com, hence the api-key in my .env.example, for pulling the relevant data in but their free plan does not support the ongoing world cup so I'm leaning towards manually updating the underlying data that will populate users' groups myself.
